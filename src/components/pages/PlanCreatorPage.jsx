...
// import { Plus, Trash } from 'lucide-react'; // Assuming you have lucide-react installed
...
//         <h1 className="text-2xl font-bold mb-4">Create Your Custom Plan</h1>
...
//                 <li key={index} className="flex justify-between items-center bg-gray-700 border border-purple-500 rounded-lg p-3">
